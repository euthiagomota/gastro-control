  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-primary-700 hover:bg-primary-800 text-white text-xs sm:text-sm font-semibold px-3 sm:px-4 py-2 rounded-lg transition-colors whitespace-nowrap"
          >
            Entrar
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-10 pb-14 sm:pt-16 sm:pb-20 lg:pt-20 lg:pb-28">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-8 order-2 lg:order-1">
              ...
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-primary-50 border border-primary-200 rounded-full px-3 sm:px-4 py-1.5">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm sm:text-lg text-gray-500 leading-relaxed max-w-xl">
              ...
              <div className="flex items-center gap-3 pt-1 flex-wrap">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">+1.200 restaurantes usando</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary-700 to-primary-900 aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] max-h-[600px]">
                ...
                <div className="absolute top-3 sm:top-4 right-3 sm:right-4 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-3 sm:p-4 w-40 sm:w-52">
                  <p className="text-xs font-semibold text-gray-500 mb-1">Desperdício evitado</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">R$ 2.100</p>
